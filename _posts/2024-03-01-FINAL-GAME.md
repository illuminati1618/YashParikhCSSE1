...
<body>
  ...
  <div id="instructionsOverlay" class="overlay">
    <div class="model">
      ...
      <p style="text-align: center; color: black;">This is a 2 player game, where each player controls one tank. Each tank can shoot a bullet with a cooldown, and the aim of the game is to kill the other tank before they kill yours. Remember, you can kill yourself with your own bullet on accident, if it bounces off of a wall and hits you!</p>
